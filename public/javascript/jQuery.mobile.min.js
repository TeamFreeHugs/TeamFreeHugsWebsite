...
(function (e, t, n) {
    ...
    (function (e, t, r) {
        ...
        e.fn.buttonMarkup = function (n, a) {
            ...
            for (f = 0; f < this.length; f++) {
                c = this[f], l = a ? {
                    alreadyEnhanced: !1,
                    unknownClasses: []
                } : o(c.className), h = e.extend({}, l.alreadyEnhanced ? l.options : {}, n);
        ...
        e.fn.grid = function (t) {
            return this.each(function () {
                var n = e(this), r = e.extend({grid: null}, t), i = n.children(), s = {
                    solo: 1,
                    a: 2,
                    b: 3,
                    c: 4,
        ...
        e.mobile.Navigator = function (t) {
            ...
            squash: function (r, s) {
                ...
                this.history.direct({
                    url: (t.originalEvent.state || {}).url || n, present: function (n, r) {
        ...
        var n = e("head").children("base"), r = {
            element: n.length ? n : e("<base>", {href: e.mobile.path.documentBase.hrefNoHash}).prependTo(e("head")),
        ...
        e.mobile.Transition = function () {
            ...
            toPreClass: " ui-page-pre-in", init: function (t, n, r, i) {
        ...
        e.widget("mobile.pagecontainer", {
            ...
            _handleNavigate: function (t, n) {
                var r = e.mobile.path.stripHash(t), i = this._getHistory(), s = i.stack.length === 0 ? "none" : this._transitionFromHistory(n.direction), o = {
                    changeHash: !1,
                    fromHashChange: !0,
                    reverse: n.direction === "back"
                };
            ...
            _triggerCssTransitionEvents: function (t, n, r) {
                ...
                r = r || "", n && (t[0] === n[0] && (i = !0), this._triggerWithDeprecated(r + "hide", {
                    ...
                    prevPage: n,
                    samePage: i
                }, n)), this._triggerWithDeprecated(r + "show", {prevPage: n || e(""), toPage: t}, t)
            },
        ...
        e.mobile.loadPage = function (t, n) {
            ...
            var n = function (t, n) {
                ...
                }), o && s.push({name: o, value: a.attr("value")}))), i = {
                    url: r,
                    options: {
                        type: f,
                        data: e.param(s),
        ...
        e.widget("mobile.collapsible", {
            options: {
                ...
                this._ui = n, this._renderedOptions = this._getOptions(this.options), this.options.enhanced ? (n.heading = this.element.children(".ui-collapsible-heading"), n.content = n.heading.next(), n.anchor = n.heading.children(), n.status = n.anchor.children(".ui-collapsible-heading-status")) : this._enhance(t, n), this._on(n.heading, {
                    tap: function () {
        ...
        e.widget("mobile.controlgroup", e.extend({
            options: {
                ...
                var t = this.element, n = this.options, r = {
        ...
        e.widget("mobile.dialog", {
            ...
            _setCloseBtn: function (t, n) {
                ...
                }).text(n || this.options.closeBtnText || "").prependTo(r), this._on(i, {click: "close"})), this._headerCloseButton = i
            },
            close: function () {
        ...
        e.widget("mobile.toolbar", {
            ...
            _create: function () {
                ...
                i.length === 0 && (i = !1, this._on(this.document, {pageshow: "refresh"})), e.extend(this, {
                    role: r,
                    page: i,
                    leftbtn: t,
                    rightbtn: n
        ...
        e.widget("mobile.checkboxradio", e.extend({
            ...
            _create: function () {
                var t = this.element, n = this.options, r = function (e, t) {
                    ...
                    isParent: !1
                } : this._findLabel(), s = t[0].type, o = "ui-" + s + "-on", u = "ui-" + s + "-off";
                if (s !== "checkbox" && s !== "radio")return;
                this.element[0].disabled && (this.options.disabled = !0), n.iconpos = r(t, "iconpos") || i.element.attr("data-" + e.mobile.ns + "iconpos") || n.iconpos, n.mini = r(t, "mini") || n.mini, e.extend(this, {
                    input: t,
                    label: i.element,
                    ...
                    checkedClass: o,
                    uncheckedClass: u
                }), this.options.enhanced || this._enhance(), this._on(i.element, {
        ...
        e.widget("mobile.flipswitch", e.extend({
            options: {
                ...
                }) : this._enhance(), this._handleFormReset(), this._originalTabIndex = this.element.attr("tabindex"), this._originalTabIndex != null && this.on.attr("tabindex", this._originalTabIndex), this.element.attr("tabindex", "-1"), this._on({focus: "_handleInputFocus"}), this.element.is(":disabled") && this._setOptions({disabled: !0}), this._on(this.flipswitch, {
                    click: "_toggle",
                    swipeleft: "_left",
                    swiperight: "_right"
        ...
        e.widget("mobile.slider", e.extend({
            ...
            _create: function () {
                ...
                v.attr("id", m), this.isToggleSwitch = c, w.setAttribute("href", "#"), S.setAttribute("role", "application"), S.className = [this.isToggleSwitch ? "ui-slider ui-slider-track ui-shadow-inset " : "ui-slider-track ui-shadow-inset ", p, u, a, f].join(""), w.className = "ui-slider-handle", S.appendChild(w), E.attr({
                    role: "slider",
                    "aria-valuemin": g,
                    "aria-valuemax": y,
                ...
                s.addClass(c ? "ui-slider-switch" : "ui-slider-input"), this._on(s, {
                    change: "_controlChange",
                    keyup: "_controlKeyup",
                    blur: "_controlBlur",
                    vmouseup: "_controlVMouseUp"
                }), x.bind("vmousedown", e.proxy(this._sliderVMouseDown, this)).bind("vclick", !1), this._on(n, {vmousemove: "_preventDocumentDrag"}), this._on(x.add(n), {vmouseup: "_sliderVMouseUp"}), x.insertAfter(s), !c && !h && (C = this.options.mini ? "<div class='ui-slider ui-mini'>" : "<div class='ui-slider'>", s.add(x).wrapAll(C)), this._on(this.handle, {
        ...
        e.widget("mobile.rangeslider", e.extend({
            options: {
                ...
                r.addClass("ui-rangeslider-first"), i.addClass("ui-rangeslider-last"), t.addClass(n), a.appendTo(c), f.appendTo(c), s.insertBefore(t), l.prependTo(f), e.extend(this, {
                    _inputFirst: r,
                    _inputLast: i,
                    _sliderFirst: a,
                    _sliderLast: f,
                    ...
                    blur: "_change",
                    keyup: "_change"
                }), this._on({mousedown: "_change"}), this._on(this.element.closest("form"), {reset: "_handleReset"}), this._on(l, {vmousedown: "_dragFirstHandle"})
        ...
        e.widget("mobile.listview", e.mobile.listview, {
            options: {autodividers: !1, autodividersSelector: r},
        ...
        e.widget("mobile.popup", {
            options: {
                ...
                r.history = r.history && e.mobile.ajaxEnabled && e.mobile.hashListeningEnabled, this._on(this.document, {vmousedown: "_handleDocumentVmousedown"}), e.extend(this, {
                    _scrollTop: 0,
                ...
                } : (this._ui = this._enhance(t, n), this._applyTransition(r.transition)), this._setTolerance(r.tolerance)._ui.focusElement = this._ui.container, this._on(this._ui.screen, {vclick: "_eatEventAndClose"}), this._on(this.window, {
                ...
                var r = this.options, i = r.wrapperClass, s = {
        ...
        e.widget("mobile.popup", e.mobile.popup, {
            options: {arrow: ""}, _create: function () {
                ...
                var t, n, r = this._ui.arrow, i = {
                    clampInfo: this._clampPopupWidth(!e),
                    arFull: {cx: r.ct.width(), cy: r.ct.height()},
                    guideDims: {cx: r.gd.width(), cy: r.gd.height()},
